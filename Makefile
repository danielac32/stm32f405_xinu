...
INCLUDES     =   -I include -I gpio/Inc -I sd-spi/Inc -I fat32/Inc -I stm32lib -I usb/Inc -I usb/class -I spi/Inc -I w25q/Inc
CFLAGS2     ?= $(CFLAGS) -mthumb $(OPTFLAGS) -nostartfiles -nostdlib -lgcc
...
SRCFLOAT         = $(wildcard float/Src/*.c)
FLOATOBJ         = $(addprefix $(OBJDIR)/, $(addsuffix .o, $(notdir $(basename $(SRCFLOAT)))))
...
SRCPATH      = $(sort $(dir $(SOURCES) $(SRCLIB) $(SRCGPIO) $(SRCUSB) $(SRCKERNEL) $(SRCFLOAT) $(SRCSPI) $(SRCFAT32) $(SRCSDSPI) $(SRCW25Q) ))
vpath %.c $(SRCPATH)
vpath %.S $(SRCPATH)
...
demo: $(DOUT).bin
		...
		#gcc -o arraytofile arraytofile.c
		#./arraytofile 
...
$(DOUT).elf : $(OBJDIR) $(LIBOBJ) $(GPIOOBJ) $(USBOBJ) $(kERNELOBJ) $(SPIOBJ) $(FLOATOBJ)  $(SDSPIOBJ) $(FAT32OBJ)  $(W25QOBJ) $(OBJECTS) 
	@echo building $@
	@$(LD) $(CFLAGS2) $(LDFLAGS) -Wl,--script='$(LDSCRIPT)' $(LIBOBJ) $(GPIOOBJ) $(FLOATOBJ) $(USBOBJ) $(FAT32OBJ) $(SDSPIOBJ) $(W25QOBJ) $(SPIOBJ) $(kERNELOBJ) $(OBJECTS) -o $@
